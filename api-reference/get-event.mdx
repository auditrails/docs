---
title: "Get Single Event — AuditRails API Reference"
sidebarTitle: "Get Event"
description: "Fetch the full detail of a single audit log event by its ULID log_id, including hash chain fields for tamper verification."
---
