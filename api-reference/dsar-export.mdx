---
title: "DSAR Export — Right of Access & Data Portability"
...
1. **Scans hot storage.** All events in ClickHouse (your active, searchable log store) where `actor_id` exactly matches the value you supplied are identified across the full retention period for your plan.
