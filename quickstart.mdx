...
<Steps>
  ...
  <Step title="Create Your Free Account">
    Head to [app.auditrails.io/register](https://app.auditrails.io/register) and sign up for a free account. You get a **30-day free trial** with no credit card required — full platform access from day one.
...
<CardGroup cols={2}>
  ...
  <Card title="Compliance Guides" icon="clipboard-check" href="/guides/compliance-mapping">
    See how AuditRails satisfies DORA, GDPR, NIS2, the EU AI Act, and the other four supported frameworks.
  </Card>
</CardGroup>
