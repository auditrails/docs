...
- **How to resolve:** Wait the number of seconds specified in the `Retry-After` response header, then retry. If you consistently hit this limit, upgrade your plan or [get in touch](https://auditrails.io/en/contact) about a custom limit.
...
|---|---|
| Starter Trails | 50,000 events / month |
| Framework Trails | 250,000 events / month |
| Compliance Trails | 1,000,000 events / month |

Events beyond the included quota are billed at EUR 0.50 per 1,000. The quota is an included allowance, not a hard cap, so exceeding it does not stop ingestion.
...
5. **Upgrade your plan for higher monthly quotas.** If you are consistently approaching your monthly event quota, upgrade to Framework Trails or Compliance Trails, which include five and twenty times the monthly allowance respectively.

---

## Custom Rate Limits

If your use case requires a rate limit higher than your plan's default, [get in touch](https://auditrails.io/en/contact). Custom limits are available on all paid plans and are configured at the project level.

[Contact us →](https://auditrails.io/en/contact)
