---
title: "PHP SDK — AuditRails Composer Audit Logging Client"
sidebarTitle: "PHP"
...
<Note>
  **Not on Packagist yet**, so `composer require auditrails/auditrails-php`
  does not resolve on its own. Point Composer at the Git repository first and
...
Requires **PHP 8.1+**. Once it is on Packagist, the first `composer config`
