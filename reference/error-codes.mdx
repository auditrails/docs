---
title: "Error Codes Reference: All API Error Responses"
sidebarTitle: "Error Codes"
description: "Complete reference for every AuditRails API error code, its HTTP status, root cause, and the exact steps needed to resolve it."
---
