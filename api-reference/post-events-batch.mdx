---
title: "Log Up to 100 Audit Events — POST /v1/events/batch"
...
<ParamField body="events" type="array" required>
  ...
  <Expandable title="Event object fields">
    <ParamField body="action" type="string" required>
      A string identifying what happened. Maximum 255 characters. We strongly recommend the `resource.verb` format (e.g. `user.login`, `document.created`, `permission.granted`).
    </ParamField>
