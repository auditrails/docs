...
sidebarTitle: "Home"
description: "AuditRails is a tamper-proof audit logging platform with SHA-256 hash chaining, WORM storage, and built-in compliance for DORA, GDPR, NIS2, the EU AI Act, ISO 27001, SOC 2, PCI DSS, and the Garante provision on system administrators."
---
...
<Steps>
  <Step title="Create an account">
    Sign up at [app.auditrails.io/register](https://app.auditrails.io/register). Every plan starts with a 30-day free trial, no credit card required.
  </Step>
  ...
  <Step title="Install an SDK">
    Install the SDK for your language, or skip it entirely and call the REST API. Node.js, Python, Go and PHP all install from their usual package managers. See the [SDK overview](/sdks/overview).
  </Step>
...
<CardGroup cols={2}>
  ...
  <Card title="WORM Storage" icon="lock">
    Logs are written to S3 Object Lock in COMPLIANCE mode, immutable even against AWS root. Required for SOC 2, DORA Art.6, and PCI DSS Requirement 10.5.
  </Card>
  <Card title="8 Compliance Frameworks" icon="shield-check">
    Built-in support for DORA, GDPR, NIS2, the EU AI Act, ISO 27001, SOC 2, PCI DSS, and the Italian Garante provision on system administrators. Auto-verification included.
  </Card>
  <Card title="Drop-In SDKs" icon="code">
    Official SDKs for Node.js, Python, Go, and PHP. Fire-and-forget `log()` never blocks your application.
  </Card>
...
<CardGroup cols={2}>
  <Card title="Compliance Mapping" icon="clipboard-check" href="/guides/compliance-mapping">
    See exactly how AuditRails maps to DORA, GDPR, NIS2, the EU AI Act, ISO 27001, SOC 2, PCI DSS, and the Garante provision on system administrators.
  </Card>
