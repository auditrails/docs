...
<ParamField body="action" type="string" required>
  A string identifying what happened. Maximum 255 characters. We strongly recommend the `resource.verb` format (e.g. `user.login`, `document.deleted`, `permission.granted`) for consistency and searchability.
</ParamField>
