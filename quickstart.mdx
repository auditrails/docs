...
<Steps>
  ...
  <Step title="Create Your Free Account">
    Head to [app.auditrails.io/register](https://app.auditrails.io/register) and sign up for a free account. You get a **60-day free trial** with no credit card required — full platform access from day one.

    <Tip>
      Your account starts on the Developer plan. You can upgrade at any time from **Dashboard → Billing** without losing any existing log data.
    </Tip>
  </Step>
