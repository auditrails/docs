...
description: "AuditRails is a tamper-proof audit logging platform with immutable hash-chained logs, WORM storage, and compliance coverage for 16+ frameworks including SOC 2, HIPAA, and PCI DSS."
---
...
<CardGroup cols={2}>
  ...
  <Card title="Drop-In SDKs" icon="code" href="/sdks">
...
<CardGroup cols={2}>
  ...
  <Card title="SDK Guides" icon="book" href="/sdks">
