---
title: "GDPR Compliance with AuditRails"
sidebarTitle: "GDPR"
description: "Configure AuditRails as a GDPR-compliant data processor: sign your DPA, handle DSARs, minimise PII in logs, and manage data residency."
---
...
| Starter | `us-east-1` (Northern Virginia, USA) |
| Pro | `us-east-1` (Northern Virginia, USA) |
| Enterprise | `us-east-1` or `eu-west-1` (Ireland, EU) |

If your GDPR obligations require that personal data not leave the EU, you need an **Enterprise plan** with EU storage (`eu-west-1`) enabled. Contact your account manager to configure EU-only storage.
