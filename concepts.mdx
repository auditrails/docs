...
| Compliance Trails | All 8, bundled free, unlimited | Regulated industries, long-term compliance |

Every plan includes compliance framework logging; the tier decides how many you can run at once. All plans include the same 180-day base retention. See [Retention](#retention) below for how enabling a compliance framework can extend it.
...
Enabling a compliance framework with a longer minimum retention requirement extends this automatically, and the longest applicable period always wins. For example, enabling the **EU AI Act** raises effective retention to **10 years**; **DORA**, **GDPR** and **NIS2** each set a **5-year** minimum; **ISO 27001** sets **3 years**. See [Compliance Mapping](/guides/compliance-mapping#retention-at-a-glance) for the full table.
