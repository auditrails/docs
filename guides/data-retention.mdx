...
| Plan | Hot Storage | Cold Storage (S3 WORM) |
|------|-------------|------------------------|
| Developer | 90 days | 90 days |
| Starter Trails | 1 year | 1 year |
| Framework Trails | 1 year | 1 year |
| Compliance Trails | Unlimited | Unlimited |
...
### Compliance Trails Custom Retention

On Compliance Trails you can configure:
...
- **EU-only storage** — events stored exclusively in `eu-west-1` for GDPR data residency requirements (Developer, Starter Trails, and Framework Trails store data in `us-east-1` only)

Contact your account manager or open a support ticket to configure custom Compliance Trails retention.
...
<Accordion title="Can I increase retention on my current plan?">
  Retention periods are tied to your plan. To increase beyond your plan's default, either upgrade your plan or enable a compliance framework that requires a longer period (e.g., SOX for 7 years). Compliance Trails customers can request custom periods up to 10 years.
</Accordion>
...
<Accordion title="Where is my data stored geographically?">
  Developer, Starter Trails, and Framework Trails store data in `us-east-1` (Northern Virginia, USA). Compliance Trails can choose `us-east-1` or `eu-west-1` (Ireland, EU). EU storage is required for GDPR data residency compliance in certain jurisdictions.
</Accordion>
