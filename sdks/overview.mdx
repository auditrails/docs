...
Every SDK is a thin client over the same REST endpoint. If your language is not ready yet, or you would rather not take a dependency, [`POST /v1/events`](/api-reference/post-events) is the whole interface and is fully supported.
