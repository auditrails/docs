---
title: "Core Concepts — How AuditRails Works"
sidebarTitle: "Concepts"
description: "Learn the core building blocks of AuditRails: organizations, projects, events, tamper-proof hash chains, dual-tier storage, retention policies, and API key scoping."
---
...
|---|---|---|
| Developer | 90 days | Personal projects, prototypes |
| Starter | 1 year | Small production applications |
| Pro | 1 year | Growing teams with multiple services |
| Enterprise | 7 years | Regulated industries, long-term compliance |
...
- **`timestamp`** — the server-assigned ingest timestamp for this event.
...
Retention periods are determined by your plan and begin from the event's ingest timestamp:
